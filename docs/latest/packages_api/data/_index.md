...
|  [PluginSignatureType](./pluginsignaturetype/) | Describes level of [plugin signature level](https://grafana.com/docs/grafana/latest/plugins/plugin-signatures/#plugin-signature-levels/) |
...
|  [scaledUnits(factor, extArray, offset)](./scaledunits/) |  |
...
|  [DataSourceWithLogsContextSupport](./datasourcewithlogscontextsupport/) | Data sources that allow showing context rows around the provided LowRowModel should implement this method. This will enable "context" button in Logs Panel. |
...
|  [Vector](./vector/) |  |
|  [WithAccessControlMetadata](./withaccesscontrolmetadata/) | With RBAC, the backend will return additional access control metadata to objects. These metadata will contain user permissions associated to a given resource.<!-- -->For example: { accessControl: { "datasources:read": true, "datasources:write": true } } |
|  [YAxis](./yaxis/) |  |
...
|  [getWeekdayIndexByEnglishName](./getweekdayindexbyenglishname/) |  |
