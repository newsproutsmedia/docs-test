...
|  [test](#test-property) | <code>(line: string) =&gt; boolean</code> | Function to verify if this is a valid parser for the given line. The parser accepts the line if it returns true. |
