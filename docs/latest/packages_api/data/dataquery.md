...
|  --- | --- | --- |
|  [datasource](#datasource-property) | <code>DataSourceRef &#124; null</code> | For mixed data sources the selected datasource is on the query level. For non mixed scenarios this is undefined. |
