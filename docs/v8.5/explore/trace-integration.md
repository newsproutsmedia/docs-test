---
aliases:
  - /docs/grafana/v8.5/explore/trace-integration/
...
For details about the types see [TraceSpanRow](https://grafana.com/docs/grafana/v8.5/packages_api/data/tracespanrow/), [TraceKeyValuePair](https://grafana.com/docs/grafana/v8.5/packages_api/data/tracekeyvaluepair/) and [TraceLog](https://grafana.com/docs/grafana/v8.5/packages_api/data/tracelog/)
