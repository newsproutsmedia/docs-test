...
|  --- | --- | --- |
|  [access](#access-property) | <code>'direct' &#124; 'proxy'</code> |  |
...
|  [rawRef](#rawref-property) | <code>DataSourceRef</code> | When the name+uid are based on template variables, maintain access to the real values |
