...
|  [PluginSignatureStatus](./pluginsignaturestatus/) | Describes status of [plugin signature](https://grafana.com/docs/grafana/v8.5/plugins/plugin-signatures/) |
|  [PluginSignatureType](./pluginsignaturetype/) | Describes level of [plugin signature level](https://grafana.com/docs/grafana/v8.5/plugins/plugin-signatures/#plugin-signature-levels/) |
|  [PluginState](./pluginstate/) | Describes plugins life cycle status |
|  [PluginType](./plugintype/) | Describes [type of plugin](https://grafana.com/docs/grafana/v8.5/plugins) |
|  [ReducerID](./reducerid/) |  |
...
|  [GroupingToMatrixTransformerOptions](./groupingtomatrixtransformeroptions/) |  |
...
|  [preferredVisualizationTypes](./preferredvisualizationtypes/) |  |
...
|  [NavIndex](./navindex/) |  |
|  [OAuth](./oauth/) | Supported OAuth services |
|  [OAuthSettings](./oauthsettings/) | Map of enabled OAuth services and their respective names |
