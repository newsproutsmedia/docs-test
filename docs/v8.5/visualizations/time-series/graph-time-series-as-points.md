---
aliases:
  - /docs/grafana/v8.5/panels/visualizations/time-series/graph-time-series-as-points/
  - /docs/grafana/v8.5/visualizations/time-series/graph-time-series-as-points/
keywords:
  - grafana
  - time series panel
  - documentation
