---
aliases:
  - /docs/grafana/v8.5/features/panels/histogram/
  - /docs/grafana/v8.5/panels/visualizations/time-series/graph-time-series-stacking/
  - /docs/grafana/v8.5/visualizations/time-series/graph-time-series-stacking/
keywords:
  - grafana
  - time series panel
  - documentation
