---
aliases:
  - /docs/grafana/v8.5/features/panels/table_panel/
  - /docs/grafana/v8.5/panels/visualizations/table/filter-table-columns/
  - /docs/grafana/v8.5/reference/table/
  - /docs/grafana/v8.5/visualizations/table/filter-table-columns/
