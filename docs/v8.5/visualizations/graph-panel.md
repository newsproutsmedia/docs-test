---
aliases:
  - /docs/grafana/v8.5/features/panels/graph/
  - /docs/grafana/v8.5/panels/visualizations/graph-panel/
  - /docs/grafana/v8.5/reference/graph/
  - /docs/grafana/v8.5/visualizations/graph-panel/
keywords:
  - grafana
  - graph panel
  - documentation
