---
aliases:
  - /docs/grafana/v8.5/features/panels/logs/
  - /docs/grafana/v8.5/panels/visualizations/logs-panel/
  - /docs/grafana/v8.5/reference/logs/
  - /docs/grafana/v8.5/visualizations/logs-panel/
keywords:
  - grafana
  - dashboard
  - documentation
