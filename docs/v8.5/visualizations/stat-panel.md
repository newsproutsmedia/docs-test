---
aliases:
  - /docs/grafana/v8.5/features/panels/singlestat/
  - /docs/grafana/v8.5/features/panels/stat/
  - /docs/grafana/v8.5/panels/visualizations/stat-panel/
  - /docs/grafana/v8.5/reference/singlestat/
  - /docs/grafana/v8.5/visualizations/stat-panel/
