---
aliases:
  - /docs/grafana/v8.5/features/panels/dashlist/
  - /docs/grafana/v8.5/panels/visualizations/dashboard-list-panel/
  - /docs/grafana/v8.5/reference/dashlist/
  - /docs/grafana/v8.5/visualizations/dashboard-list-panel/
keywords:
  - grafana
  - dashboard list
  - documentation
