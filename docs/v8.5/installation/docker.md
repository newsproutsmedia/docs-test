---
aliases:
  - /docs/grafana/v8.5/installation/docker/
...
For documentation regarding the configuration of a docker image, refer to [configure a Grafana Docker image](https://grafana.com/docs/grafana/v8.5/administration/configure-docker/).
