...
_build:
  list: false
aliases:
  - /docs/grafana/v8.5/guides/whats-new-in-v7-0/
  - /docs/grafana/v8.5/whatsnew/whats-new-in-v7-0/
...
The `@grafana/data`, `@grafana/runtime`, `@grafana/e2e packages` (also available via NPM) aim to simplify the way plugins are developed. We want to deliver a set of [reliable APIs](https://grafana.com/docs/grafana/v8.5/packages_api/) for plugin developers.
