---
aliases:
  - /docs/grafana/v8.5/developers/plugins/add-support-for-explore-queries/
...
For possible options, refer to [PreferredVisualisationType](https://grafana.com/docs/grafana/v8.5/packages_api/data/preferredvisualisationtype/).
