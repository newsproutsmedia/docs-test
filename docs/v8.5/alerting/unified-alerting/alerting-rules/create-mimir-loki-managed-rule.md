---
aliases:
  - /docs/grafana/v8.5/alerting/unified-alerting/alerting-rules/create-cortex-loki-managed-recording-rule/
  - /docs/grafana/v8.5/alerting/unified-alerting/alerting-rules/create-mimir-loki-managed-rule/
