---
aliases:
  - /docs/grafana/v8.5/datasources/tempo/
  - /docs/grafana/v8.5/features/datasources/tempo/
...
You can pan and zoom the view with buttons or you mouse. For details about the visualization, refer to [Node graph panel](https://grafana.com/docs/grafana/v8.5/panels/visualizations/node-graph/).
