---
aliases:
  - /docs/grafana/v8.5/datasources/azuremonitor/
  - /docs/grafana/v8.5/features/datasources/azuremonitor/
...
To enable managed identity for Grafana, set the `managed_identity_enabled` flag in the `[azure]` section of the [Grafana server config](https://grafana.com/docs/grafana/v8.5/administration/configuration/#azure).
