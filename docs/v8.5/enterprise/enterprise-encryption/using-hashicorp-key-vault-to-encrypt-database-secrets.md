---
aliases:
  - /docs/grafana/v8.5/enterprise/enterprise-encryption/using-hashicorp-key-vault-to-encrypt-database-secrets/
...
7. [Restart Grafana](https://grafana.com/docs/grafana/v8.5/installation/restart-grafana/).
