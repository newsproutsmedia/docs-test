---
aliases:
  - /docs/grafana/v8.5/enterprise/enterprise-encryption/using-google-cloud-kms-to-encrypt-database-secrets/
...
8. [Restart Grafana](https://grafana.com/docs/grafana/v8.5/installation/restart-grafana/).
