---
aliases:
  - /docs/grafana/v8.5/administration/manage-users-and-permissions/about-users-and-permissions/
  - /docs/grafana/v8.5/manage-users/
  - /docs/grafana/v8.5/permissions/
  - /docs/grafana/v8.5/permissions/organization_roles/
  - /docs/grafana/v8.5/permissions/overview/
