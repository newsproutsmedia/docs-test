---
aliases:
  - /docs/grafana/v8.5/administration/manage-users-and-permissions/manage-teams/
  - /docs/grafana/v8.5/manage-users/add-or-remove-user-from-team/
  - /docs/grafana/v8.5/manage-users/create-or-remove-team/
  - /docs/grafana/v8.5/manage-users/manage-teams/
title: Manage teams
weight: 600
---
