---
aliases:
  - /docs/grafana/v8.5/administration/manage-users-and-permissions/manage-server-users/add-remove-user-to-org/
  - /docs/grafana/v8.5/administration/manage-users-and-permissions/manage-server-users/add-user-to-org/
