...
|  [PluginSignatureStatus](./pluginsignaturestatus/) | Describes status of [plugin signature](https://grafana.com/docs/grafana/v8.1/plugins/plugin-signatures/) |
|  [PluginSignatureType](./pluginsignaturetype/) | Describes level of [plugin signature level](https://grafana.com/docs/grafana/v8.1/plugins/plugin-signatures/#plugin-signature-levels/) |
|  [PluginState](./pluginstate/) | Describes plugins life cycle status |
|  [PluginType](./plugintype/) | Describes [type of plugin](https://grafana.com/docs/grafana/v8.1/plugins) |
|  [ReducerID](./reducerid/) |  |
...
|  [intervalToAbbreviatedDurationString(interval, includeSeconds)](./intervaltoabbreviateddurationstring/) | intervalToAbbreviatedDurationString convers interval to readable duration string |
