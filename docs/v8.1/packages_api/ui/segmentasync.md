...
|  --- | --- | --- |
|  { value, onChange, loadOptions, Component, className, allowCustomValue, allowEmptyValue, disabled, placeholder, inputMinWidth, inputPlaceholder, autofocus, onExpandedChange, noOptionMessageHandler, ...rest } | <code>React.PropsWithChildren&lt;SegmentAsyncProps&lt;T&gt;&gt;</code> |  |
