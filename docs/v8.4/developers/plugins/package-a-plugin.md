...
type = "docs"
aliases = ["/docs/grafana/v8.4/developers/plugins/share-a-plugin/"]
+++
...
1. Enter the information requested by the form.
   ...
   - The remaining questions help us determine the [signature level](https://grafana.com/docs/grafana/v8.4/plugins/plugin-signatures/#plugin-signature-levels) for your plugin.
1. Click **Submit**.
