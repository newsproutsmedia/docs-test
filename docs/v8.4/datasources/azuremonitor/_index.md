...
aliases = ["/docs/grafana/v8.4/features/datasources/azuremonitor"]
weight = 300
+++
...
To enable managed identity for Grafana, set the `managed_identity_enabled` flag in the `[azure]` section of the [Grafana server config](https://grafana.com/docs/grafana/v8.4/administration/configuration/#azure).
