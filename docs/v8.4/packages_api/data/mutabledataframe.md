...
|  --- | --- | --- |
|  [add(value)](#add-method) |  | Add values from an object to corresponding fields. Similar to appendRow but does not create new fields. |
...
|  [setParser(field, parser)](#setparser-method) |  |  |
