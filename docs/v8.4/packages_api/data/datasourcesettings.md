...
```typescript
export interface DataSourceSettings<T extends DataSourceJsonData = DataSourceJsonData, S = {}> extends WithAccessControlMetadata 
```
<b>Import</b>
...
|  [typeName](#typename-property) | <code>string</code> |  |
