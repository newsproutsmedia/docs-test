...
aliases = ["/docs/grafana/v8.4/guides/glossary", "/docs/grafana/v8.4/getting-started/glossary"]
weight = 800
+++
...
<table>
  ...
  <tr>
    ...
    <td>
      Explore allows a user to focus on building a query. Users can refine the query to return the expected metrics before building a dashboard. For more information, refer to the <a href="https://grafana.com/docs/grafana/v8.4/explore">Explore</a> topic.
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      Transformations process the result set of a query before it’s passed on for visualization. For more information, refer to the <a href="https://grafana.com/docs/grafana/v8.4/panels/transformations">Transformations overview</a> topic.
    </td>
  </tr>
  <tr>
