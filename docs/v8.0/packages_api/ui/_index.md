...
|  [Segment({ options, value, onChange, Component, className, allowCustomValue, placeholder, disabled, ...rest })](./segment/) |  |
|  [SegmentAsync({ value, onChange, loadOptions, Component, className, allowCustomValue, disabled, placeholder, noOptionMessageHandler, ...rest })](./segmentasync/) |  |
|  [SegmentInput({ value: initialValue, onChange, Component, className, placeholder, disabled, autofocus, ...rest })](./segmentinput/) |  |
|  [Select(props)](./select/) |  |
