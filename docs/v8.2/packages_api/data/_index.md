...
|  [PluginSignatureStatus](./pluginsignaturestatus/) | Describes status of [plugin signature](https://grafana.com/docs/grafana/v8.2/plugins/plugin-signatures/) |
|  [PluginSignatureType](./pluginsignaturetype/) | Describes level of [plugin signature level](https://grafana.com/docs/grafana/v8.2/plugins/plugin-signatures/#plugin-signature-levels/) |
|  [PluginState](./pluginstate/) | Describes plugins life cycle status |
|  [PluginType](./plugintype/) | Describes [type of plugin](https://grafana.com/docs/grafana/v8.2/plugins) |
|  [ReducerID](./reducerid/) |  |
...
|  [DatasourceRef](./datasourceref/) | In 8.2, this will become an interface |
