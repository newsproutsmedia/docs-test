...
|  --- | --- | --- |
|  [QueryEditor](#queryeditor-property) | <code>ComponentType&lt;AnnotationQueryEditorProps&lt;TQuery&gt;&gt;</code> | Specify a custom QueryEditor for the annotation page. If not specified, the standard one will be used |
