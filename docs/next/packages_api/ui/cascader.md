...
|  --- | --- | --- | --- |
|  [defaultProps](#defaultprops-property) | <code>static</code> | <code>{</code><br/><code>        changeOnSelect: boolean;</code><br/><code>    }</code> |  |
|  [flattenOptions](#flattenoptions-property) |  | <code>(options: CascaderOption[], optionPath?: CascaderOption[]) =&gt; SelectableValue&lt;string[]&gt;[]</code> |  |
|  [getSearchableOptions](#getsearchableoptions-property) |  | <code>import(&quot;memoize-one&quot;).MemoizedFn&lt;(options: CascaderOption[]) =&gt; SelectableValue&lt;string[]&gt;[]&gt;</code> |  |
...
|  [onSelectInputChange](#onselectinputchange-property) |  | <code>(value: string) =&gt; void</code> |  |
